...
namespace {
	...
	void registerClass(lua_State* L, std::string_view className, std::string_view baseClass, lua_CFunction newFunction = nullptr) {
		...
		lua::pushNumber(L, std::hash<std::string_view>()(className));
		...
		if (className == "Item") {
			lua::pushNumber(L, LuaData_Item);
		} else if (className == "Container") {
			lua::pushNumber(L, LuaData_Container);
		} else if (className == "Teleport") {
			lua::pushNumber(L, LuaData_Teleport);
		} else if (className == "Podium") {
			lua::pushNumber(L, LuaData_Podium);
		} else if (className == "Player") {
			lua::pushNumber(L, LuaData_Player);
		} else if (className == "Monster") {
			lua::pushNumber(L, LuaData_Monster);
		} else if (className == "Npc") {
			lua::pushNumber(L, LuaData_Npc);
		} else if (className == "Tile") {
			lua::pushNumber(L, LuaData_Tile);
		} else {
			lua::pushNumber(L, LuaData_Unknown);
		}
...
int LuaScriptInterface::luaGetWorldLight(lua_State* L) {
	...
	lua::pushNumber(L, lightInfo.color);
	return 2;
}
...
int LuaScriptInterface::luaGetDepotId(lua_State* L) {
	...
	lua::pushNumber(L, depotLocker->getDepotId());
	return 1;
}
...
int LuaScriptInterface::luaCleanMap(lua_State* L) {
	lua::pushNumber(L, g_game.map.clean());
	return 1;
}
...
int LuaScriptInterface::luaBitNot(lua_State* L) {
	lua::pushNumber(L, ~lua::getNumber<uint32_t>(L, -1));
	return 1;
}
...
int LuaScriptInterface::luaConfigManagerGetNumber(lua_State* L) {
	lua::pushNumber(L, ConfigManager::getNumber(lua::getNumber<ConfigManager::integer_config_t>(L, -1)));
	return 1;
}
...
int LuaScriptInterface::luaDatabaseStoreQuery(lua_State* L) {
	if (DBResult_ptr res = Database::getInstance().storeQuery(lua::getString(L, -1))) {
		lua::pushNumber(L, addResult(res));
	} else {
		lua::pushBoolean(L, false);
	}
	return 1;
...
int LuaScriptInterface::luaDatabaseAsyncStoreQuery(lua_State* L) {
	...
	if (lua_gettop(L) > 1) {
		...
		callback = [ref, scriptId](const DBResult_ptr& result, bool) {
			...
			lua_rawgeti(L, LUA_REGISTRYINDEX, ref);
			if (result) {
				lua::pushNumber(L, addResult(result));
			} else {
				lua::pushBoolean(L, false);
			}
			auto env = lua::getScriptEnv();
...
int LuaScriptInterface::luaDatabaseLastInsertId(lua_State* L) {
	lua::pushNumber(L, Database::getInstance().getLastInsertId());
	return 1;
}
...
int LuaScriptInterface::luaResultGetNumber(lua_State* L) {
	...
	lua::pushNumber(L, res->getNumber<int64_t>(s));
	return 1;
}
...
int LuaScriptInterface::luaGameGetExperienceStage(lua_State* L) {
	...
	lua::pushNumber(L, ConfigManager::getExperienceStage(level));
	return 1;
}
...
int LuaScriptInterface::luaGameGetExperienceForLevel(lua_State* L) {
	...
	if (level == 0) {
		...
		lua::pushNumber(L, Player::getExpForLevel(level));
	}
	return 1;
}
...
int LuaScriptInterface::luaGameGetMonsterCount(lua_State* L) {
	...
	lua::pushNumber(L, g_game.getMonstersOnline());
	return 1;
}

int LuaScriptInterface::luaGameGetPlayerCount(lua_State* L) {
	// Game.getPlayerCount()
	lua::pushNumber(L, g_game.getPlayersOnline());
	return 1;
}

int LuaScriptInterface::luaGameGetNpcCount(lua_State* L) {
	// Game.getNpcCount()
	lua::pushNumber(L, g_game.getNpcsOnline());
	return 1;
}
...
int LuaScriptInterface::luaGameGetGameState(lua_State* L) {
	// Game.getGameState()
	lua::pushNumber(L, g_game.getGameState());
	return 1;
}
...
int LuaScriptInterface::luaGameGetWorldType(lua_State* L) {
	// Game.getWorldType()
	lua::pushNumber(L, g_game.getWorldType());
	return 1;
}
...
int LuaScriptInterface::luaGameGetItemAttributeByName(lua_State* L) {
	...
	lua::pushNumber(L, stringToItemAttribute(lua::getString(L, 1)));
	return 1;
}
...
int LuaScriptInterface::luaGameGetAccountStorageValue(lua_State* L) {
	...
	lua::pushNumber(L, g_game.getAccountStorageValue(accountId, key));
...
int LuaScriptInterface::luaVariantGetNumber(lua_State* L) {
	...
	if (variant.isNumber()) {
		lua::pushNumber(L, variant.getNumber());
	} else {
		lua::pushNumber(L, 0);
	}
	return 1;
...
int LuaScriptInterface::luaPositionGetDistance(lua_State* L) {
	...
	const Position& positionEx = lua::getPosition(L, 2);
	const Position& position = lua::getPosition(L, 1);
	lua::pushNumber(L, std::max<int32_t>(
		std::max<int32_t>(
...
int LuaScriptInterface::luaTileGetThingCount(lua_State* L) {
	...
	Tile* tile = lua::getUserdata<Tile>(L, 1);
	if (tile) {
		lua::pushNumber(L, tile->getThingCount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaTileGetItemCountById(lua_State* L) {
	...
	lua::pushNumber(L, tile->getItemTypeCount(itemId, subType));
	return 1;
}
...
int LuaScriptInterface::luaTileGetItemCount(lua_State* L) {
	...
	lua::pushNumber(L, tile->getItemCount());
	return 1;
}
...
int LuaScriptInterface::luaTileGetDownItemCount(lua_State* L) {
	...
	Tile* tile = lua::getUserdata<Tile>(L, 1);
	if (tile) {
		lua::pushNumber(L, tile->getDownItemCount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaTileGetTopItemCount(lua_State* L) {
	...
	lua::pushNumber(L, tile->getTopItemCount());
	return 1;
}
...
int LuaScriptInterface::luaTileGetCreatureCount(lua_State* L) {
	...
	lua::pushNumber(L, tile->getCreatureCount());
	return 1;
}
...
int LuaScriptInterface::luaTileGetThingIndex(lua_State* L) {
	...
	if (thing) {
		lua::pushNumber(L, tile->getThingIndex(thing));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaTileQueryAdd(lua_State* L) {
	...
	if (thing) {
		...
		lua::pushNumber(L, tile->queryAdd(0, *thing, 1, flags));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaNetworkMessageGetByte(lua_State* L) {
	...
	if (message) {
		lua::pushNumber(L, message->getByte());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaNetworkMessageGetU16(lua_State* L) {
	...
	NetworkMessage* message = lua::getUserdata<NetworkMessage>(L, 1);
	if (message) {
		lua::pushNumber(L, message->get<uint16_t>());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaNetworkMessageGetU32(lua_State* L) {
	...
	NetworkMessage* message = lua::getUserdata<NetworkMessage>(L, 1);
	if (message) {
		lua::pushNumber(L, message->get<uint32_t>());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaNetworkMessageGetU64(lua_State* L) {
	...
	NetworkMessage* message = lua::getUserdata<NetworkMessage>(L, 1);
	if (message) {
		lua::pushNumber(L, message->get<uint64_t>());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaNetworkMessageTell(lua_State* L) {
	...
	NetworkMessage* message = lua::getUserdata<NetworkMessage>(L, 1);
	if (message) {
		lua::pushNumber(L, message->getBufferPosition() - message->INITIAL_BUFFER_POSITION);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaNetworkMessageLength(lua_State* L) {
	...
	NetworkMessage* message = lua::getUserdata<NetworkMessage>(L, 1);
	if (message) {
		lua::pushNumber(L, message->getLength());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaModalWindowGetButtonCount(lua_State* L) {
	...
	ModalWindow* window = lua::getUserdata<ModalWindow>(L, 1);
	if (window) {
		lua::pushNumber(L, window->buttons.size());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaModalWindowGetChoiceCount(lua_State* L) {
	...
	ModalWindow* window = lua::getUserdata<ModalWindow>(L, 1);
	if (window) {
		lua::pushNumber(L, window->choices.size());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaModalWindowGetDefaultEnterButton(lua_State* L) {
	...
	ModalWindow* window = lua::getUserdata<ModalWindow>(L, 1);
	if (window) {
		lua::pushNumber(L, window->defaultEnterButton);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaModalWindowGetDefaultEscapeButton(lua_State* L) {
	...
	ModalWindow* window = lua::getUserdata<ModalWindow>(L, 1);
	if (window) {
		lua::pushNumber(L, window->defaultEscapeButton);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemGetActionId(lua_State* L) {
	...
	Item* item = lua::getUserdata<Item>(L, 1);
	if (item) {
		lua::pushNumber(L, item->getActionId());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemGetCount(lua_State* L) {
	...
	Item* item = lua::getUserdata<Item>(L, 1);
	if (item) {
		lua::pushNumber(L, item->getItemCount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemGetCharges(lua_State* L) {
	...
	Item* item = lua::getUserdata<Item>(L, 1);
	if (item) {
		lua::pushNumber(L, item->getCharges());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemGetFluidType(lua_State* L) {
	...
	Item* item = lua::getUserdata<Item>(L, 1);
	if (item) {
		lua::pushNumber(L, item->getFluidType());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemGetWeight(lua_State* L) {
	...
	Item* item = lua::getUserdata<Item>(L, 1);
	if (item) {
		lua::pushNumber(L, item->getWeight());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemGetWorth(lua_State* L) {
	...
	Item* item = lua::getUserdata<Item>(L, 1);
	if (item) {
		lua::pushNumber(L, item->getWorth());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemGetAttribute(lua_State* L) {
	...
	if (ItemAttributes::isIntAttrType(attribute)) {
		lua::pushNumber(L, item->getIntAttr(attribute));
...
int LuaScriptInterface::luaContainerGetSize(lua_State* L) {
	...
	if (container) {
		lua::pushNumber(L, container->size());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaContainerGetCapacity(lua_State* L) {
	...
	Container* container = lua::getUserdata<Container>(L, 1);
	if (container) {
		lua::pushNumber(L, container->capacity());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaContainerGetItemHoldingCount(lua_State* L) {
	...
	Container* container = lua::getUserdata<Container>(L, 1);
	if (container) {
		lua::pushNumber(L, container->getItemHoldingCount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaContainerGetCorpseOwner(lua_State* L) {
	...
	Container* container = lua::getUserdata<Container>(L, 1);
	if (container) {
		lua::pushNumber(L, container->getCorpseOwner());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaContainerGetItemCountById(lua_State* L) {
	...
	int32_t subType = lua::getNumber<int32_t>(L, 3, -1);
	lua::pushNumber(L, container->getItemTypeCount(itemId, subType));
	return 1;
}
...
int LuaScriptInterface::luaCreatureGetId(lua_State* L) {
	...
	const Creature* creature = lua::getUserdata<const Creature>(L, 1);
	if (creature) {
		lua::pushNumber(L, creature->getID());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureGetSpeed(lua_State* L) {
	...
	const Creature* creature = lua::getUserdata<const Creature>(L, 1);
	if (creature) {
		lua::pushNumber(L, creature->getSpeed());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureGetBaseSpeed(lua_State* L) {
	...
	const Creature* creature = lua::getUserdata<const Creature>(L, 1);
	if (creature) {
		lua::pushNumber(L, creature->getBaseSpeed());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureGetDirection(lua_State* L) {
	...
	const Creature* creature = lua::getUserdata<const Creature>(L, 1);
	if (creature) {
		lua::pushNumber(L, creature->getDirection());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureGetHealth(lua_State* L) {
	...
	const Creature* creature = lua::getUserdata<const Creature>(L, 1);
	if (creature) {
		lua::pushNumber(L, creature->getHealth());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureGetMaxHealth(lua_State* L) {
	...
	const Creature* creature = lua::getUserdata<const Creature>(L, 1);
	if (creature) {
		lua::pushNumber(L, creature->getMaxHealth());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureGetSkull(lua_State* L) {
	...
	Creature* creature = lua::getUserdata<Creature>(L, 1);
	if (creature) {
		lua::pushNumber(L, creature->getSkull());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureMove(lua_State* L) {
	...
	if (isNumber(L, 2)) {
		...
		lua::pushNumber(L, g_game.internalMoveCreature(creature, direction, FLAG_NOLIMIT));
	} else {
		...
		lua::pushNumber(L, g_game.internalMoveCreature(*creature, *tile, lua::getNumber<uint32_t>(L, 3)));
	}
	return 1;
}
...
int LuaScriptInterface::luaCreatureGetZone(lua_State* L) {
	...
	Creature* creature = lua::getUserdata<Creature>(L, 1);
	if (creature) {
		lua::pushNumber(L, creature->getZone());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureGetStorageValue(lua_State* L) {
	...
	if (auto storage = creature->getStorageValue(key)) {
		lua::pushNumber(L, storage.value());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetGuid(lua_State* L) {
	...
	if (player) {
		lua::pushNumber(L, player->getGUID());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetAccountId(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getAccount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetLastLoginSaved(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getLastLoginSaved());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetLastLogout(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getLastLogout());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetAccountType(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getAccountType());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetCapacity(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getCapacity());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetFreeCapacity(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getFreeCapacity());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetSkullTime(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getSkullTicks());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetDeathPenalty(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getLostPercent() * 100);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetExperience(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getExperience());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetLevel(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getLevel());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetMagicLevel(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getMagicLevel());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBaseMagicLevel(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getBaseMagicLevel());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetMana(lua_State* L) {
	...
	if (player) {
		lua::pushNumber(L, player->getMana());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetMaxMana(lua_State* L) {
	...
	const Player* player = lua::getUserdata<const Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getMaxMana());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetManaSpent(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getSpentMana());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBaseMaxHealth(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->healthMax);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBaseMaxMana(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->manaMax);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetSkillLevel(lua_State* L) {
	...
	if (player && skillType <= SKILL_LAST) {
		lua::pushNumber(L, player->skills[skillType].level);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetSkillPercent(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player && skillType <= SKILL_LAST) {
		lua::pushNumber(L, player->skills[skillType].percent);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetSkillTries(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player && skillType <= SKILL_LAST) {
		lua::pushNumber(L, player->skills[skillType].tries);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetSpecialSkill(lua_State* L) {
	...
	if (player && specialSkillType <= SPECIALSKILL_LAST) {
		lua::pushNumber(L, player->getSpecialSkill(specialSkillType));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetOfflineTrainingTime(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getOfflineTrainingTime());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetOfflineTrainingSkill(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getOfflineTrainingSkill());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetItemCount(lua_State* L) {
	...
	int32_t subType = lua::getNumber<int32_t>(L, 3, -1);
	lua::pushNumber(L, player->getItemTypeCount(itemId, subType));
	return 1;
}
...
int LuaScriptInterface::luaPlayerGetSex(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getSex());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetGuildLevel(lua_State* L) {
	...
	if (player && player->getGuild()) {
		lua::pushNumber(L, player->getGuildRank()->level);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetStamina(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getStaminaMinutes());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetSoul(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getSoul());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetMaxSoul(lua_State* L) {
	...
	if (player && player->vocation) {
		lua::pushNumber(L, player->vocation->getSoulMax());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBankBalance(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getBankBalance());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetMoney(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getMoney());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerShowTextDialog(lua_State* L) {
	...
	lua::pushNumber(L, player->windowTextId);
	return 1;
}
...
int LuaScriptInterface::luaPlayerGetPremiumEndsAt(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->premiumEndsAt);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetContainerId(lua_State* L) {
	...
	if (container) {
		lua::pushNumber(L, player->getContainerID(container));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetContainerIndex(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getContainerIndex(lua::getNumber<uint8_t>(L, 2)));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetFightMode(lua_State* L) {
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->fightMode);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetIdleTime(lua_State* L) {
	...
	lua::pushNumber(L, player->getIdleTime());
	return 1;
}
...
int LuaScriptInterface::luaPlayerGetClientExpDisplay(lua_State* L)
{
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getClientExpDisplay());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetClientStaminaBonusDisplay(lua_State* L)
{
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getClientStaminaBonusDisplay());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetClientLowLevelBonusDisplay(lua_State* L)
{
	...
	Player* player = lua::getUserdata<Player>(L, 1);
	if (player) {
		lua::pushNumber(L, player->getClientLowLevelBonusDisplay());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaMonsterGetId(lua_State* L) {
	...
	if (monster) {
		...
		lua::pushNumber(L, monster->getID());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaMonsterGetFriendCount(lua_State* L) {
	...
	Monster* monster = lua::getUserdata<Monster>(L, 1);
	if (monster) {
		lua::pushNumber(L, monster->getFriendList().size());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaMonsterGetTargetCount(lua_State* L) {
	...
	Monster* monster = lua::getUserdata<Monster>(L, 1);
	if (monster) {
		lua::pushNumber(L, monster->getTargetList().size());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaNpcGetSpeechBubble(lua_State* L) {
	...
	Npc* npc = lua::getUserdata<Npc>(L, 1);
	if (npc) {
		lua::pushNumber(L, npc->getSpeechBubble());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetId(lua_State* L) {
	...
	if (vocation) {
		lua::pushNumber(L, vocation->getId());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetClientId(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getClientId());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetRequiredSkillTries(lua_State* L) {
	...
	if (vocation) {
		...
		lua::pushNumber(L, vocation->getReqSkillTries(skillType, skillLevel));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetRequiredManaSpent(lua_State* L) {
	...
	if (vocation) {
		...
		lua::pushNumber(L, vocation->getReqMana(magicLevel));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetCapacityGain(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getCapGain());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetHealthGain(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getHPGain());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetHealthGainTicks(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getHealthGainTicks());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetHealthGainAmount(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getHealthGainAmount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetManaGain(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getManaGain());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetManaGainTicks(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getManaGainTicks());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetManaGainAmount(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getManaGainAmount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetMaxSoul(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getSoulMax());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetSoulGainTicks(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getSoulGainTicks());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetAttackSpeed(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getAttackSpeed());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaVocationGetBaseSpeed(lua_State* L) {
	...
	Vocation* vocation = lua::getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua::pushNumber(L, vocation->getBaseSpeed());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaHouseGetRent(lua_State* L) {
	...
	House* house = lua::getUserdata<House>(L, 1);
	if (house) {
		lua::pushNumber(L, house->getRent());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaHouseGetPaidUntil(lua_State* L) {
	...
	House* house = lua::getUserdata<House>(L, 1);
	if (house) {
		lua::pushNumber(L, house->getPaidUntil());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaHouseGetPayRentWarnings(lua_State* L) {
	...
	House* house = lua::getUserdata<House>(L, 1);
	if (house) {
		lua::pushNumber(L, house->getPayRentWarnings());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaHouseGetOwnerGuid(lua_State* L) {
	...
	House* house = lua::getUserdata<House>(L, 1);
	if (house) {
		lua::pushNumber(L, house->getOwner());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaHouseStartTrade(lua_State* L) {
	...
	if (!tradePartner->getPosition().isInRange(player->getPosition(), 2, 2, 0)) {
		lua::pushNumber(L, RETURNVALUE_TRADEPLAYERFARAWAY);
		return 1;
	}

	if (house->getOwner() != player->getGUID()) {
		lua::pushNumber(L, RETURNVALUE_YOUDONTOWNTHISHOUSE);
		return 1;
	}

	if (g_game.map.houses.getHouseByPlayerId(tradePartner->getGUID())) {
		lua::pushNumber(L, RETURNVALUE_TRADEPLAYERALREADYOWNSAHOUSE);
		return 1;
	}

	if (IOLoginData::hasBiddedOnHouse(tradePartner->getGUID())) {
		lua::pushNumber(L, RETURNVALUE_TRADEPLAYERHIGHESTBIDDER);
		return 1;
	}

	Item* transferItem = house->getTransferItem();
	if (!transferItem) {
		lua::pushNumber(L, RETURNVALUE_YOUCANNOTTRADETHISHOUSE);
		return 1;
	}
	...
	lua::pushNumber(L, RETURNVALUE_NOERROR);
	return 1;
}
...
int LuaScriptInterface::luaHouseGetBedCount(lua_State* L) {
	...
	House* house = lua::getUserdata<House>(L, 1);
	if (house) {
		lua::pushNumber(L, house->getBedCount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaHouseGetDoorCount(lua_State* L) {
	...
	House* house = lua::getUserdata<House>(L, 1);
	if (house) {
		lua::pushNumber(L, house->getDoors().size());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaHouseGetDoorIdByPosition(lua_State* L) {
	...
	if (door) {
		lua::pushNumber(L, door->getDoorId());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaHouseGetTileCount(lua_State* L) {
	...
	House* house = lua::getUserdata<House>(L, 1);
	if (house) {
		lua::pushNumber(L, house->getTiles().size());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetType(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->type);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetGroup(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->group);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetClientId(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->clientId);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetRotateTo(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->rotateTo);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetSlotPosition(lua_State *L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->slotPosition);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetCharges(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->charges);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetFluidSource(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->fluidSource);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetCapacity(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->maxItems);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetWorth(lua_State* L) {
	...
	lua::pushNumber(L, itemType->worth);
	return 1;
}
...
int LuaScriptInterface::luaItemTypeGetHitChance(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->hitChance);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetShootRange(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->shootRange);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetAttack(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->attack);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetAttackSpeed(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->attackSpeed);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetDefense(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->defense);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetExtraDefense(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->extraDefense);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetArmor(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->armor);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetWeaponType(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->weaponType);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetAmmoType(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->ammoType);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetCorpseType(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->corpseType);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetAbilities(lua_State* L) {
	...
	if (itemType) {
		...
		for (int32_t i = STAT_FIRST; i <= STAT_LAST; i++) {
			lua::pushNumber(L, abilities.stats[i]);
			lua_rawseti(L, -2, i + 1);
		}
		...
		lua_createtable(L, 0, STAT_LAST + 1);
		for (int32_t i = STAT_FIRST; i <= STAT_LAST; i++) {
			lua::pushNumber(L, abilities.statsPercent[i]);
			lua_rawseti(L, -2, i + 1);
		}
		...
		for (int32_t i = SKILL_FIRST; i <= SKILL_LAST; i++) {
			lua::pushNumber(L, abilities.skills[i]);
			lua_rawseti(L, -2, i + 1);
		}
		...
		for (int32_t i = SPECIALSKILL_FIRST; i <= SPECIALSKILL_LAST; i++) {
			lua::pushNumber(L, abilities.specialSkills[i]);
			lua_rawseti(L, -2, i + 1);
		}
		...
		for (int32_t i = 0; i < COMBAT_COUNT; i++) {
			lua::pushNumber(L, abilities.fieldAbsorbPercent[i]);
			lua_rawseti(L, -2, i + 1);
		}
		...
		lua_createtable(L, 0, COMBAT_COUNT);
		for (int32_t i = 0; i < COMBAT_COUNT; i++) {
			lua::pushNumber(L, abilities.absorbPercent[i]);
			lua_rawseti(L, -2, i + 1);
		}
...
int LuaScriptInterface::luaItemTypeGetWieldInfo(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->wieldInfo);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetDuration(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->decayTime);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetLevelDoor(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->levelDoor);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetMinReqLevel(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->minReqLevel);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetMinReqMagicLevel(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->minReqMagicLevel);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetElementType(lua_State* L) {
	...
	if (abilities) {
		lua::pushNumber(L, abilities->elementType);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetElementDamage(lua_State* L) {
	...
	auto& abilities = itemType->abilities;
	if (abilities) {
		lua::pushNumber(L, abilities->elementDamage);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetTransformEquipId(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->transformEquipTo);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetTransformDeEquipId(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->transformDeEquipTo);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetDecayId(lua_State* L) {
	...
	const ItemType* itemType = lua::getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua::pushNumber(L, itemType->decayTo);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaConditionGetId(lua_State* L) {
	...
	if (condition) {
		lua::pushNumber(L, condition->getId());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaConditionGetSubId(lua_State* L) {
	...
	Condition* condition = lua::getUserdata<Condition>(L, 1);
	if (condition) {
		lua::pushNumber(L, condition->getSubId());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaConditionGetType(lua_State* L) {
	...
	Condition* condition = lua::getUserdata<Condition>(L, 1);
	if (condition) {
		lua::pushNumber(L, condition->getType());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaConditionGetIcons(lua_State* L) {
	...
	Condition* condition = lua::getUserdata<Condition>(L, 1);
	if (condition) {
		lua::pushNumber(L, condition->getIcons());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaConditionGetEndTime(lua_State* L) {
	...
	Condition* condition = lua::getUserdata<Condition>(L, 1);
	if (condition) {
		lua::pushNumber(L, condition->getEndTime());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaConditionGetTicks(lua_State* L) {
	...
	Condition* condition = lua::getUserdata<Condition>(L, 1);
	if (condition) {
		lua::pushNumber(L, condition->getTicks());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaMonsterTypeHealth(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.health);
		} else {
...
int LuaScriptInterface::luaMonsterTypeMaxHealth(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.healthMax);
		} else {
...
int LuaScriptInterface::luaMonsterTypeRunHealth(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.runAwayHealth);
		} else {
...
int LuaScriptInterface::luaMonsterTypeExperience(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.experience);
		} else {
...
int LuaScriptInterface::luaMonsterTypeSkull(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.skull);
		} else {
			if (isNumber(L, 2)) {
...
int LuaScriptInterface::luaMonsterTypeCombatImmunities(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.damageImmunities);
		} else {
...
int LuaScriptInterface::luaMonsterTypeConditionImmunities(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.conditionImmunities);
		} else {
			std::string immunity = lua::getString(L, 2);
			if (immunity == "physical") {
...
int LuaScriptInterface::luaMonsterTypeGetElementList(lua_State* L) {
	...
	for (const auto& elementEntry : monsterType->info.elementMap) {
		lua::pushNumber(L, elementEntry.second);
...
int LuaScriptInterface::luaMonsterTypeMaxSummons(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.maxSummons);
		} else {
...
int LuaScriptInterface::luaMonsterTypeArmor(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.armor);
		} else {
...
int LuaScriptInterface::luaMonsterTypeDefense(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.defense);
		} else {
...
int LuaScriptInterface::luaMonsterTypeRace(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.race);
		} else {
			if (race == "venom") {
...
int LuaScriptInterface::luaMonsterTypeCorpseId(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.lookcorpse);
		} else {
...
int LuaScriptInterface::luaMonsterTypeManaCost(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.manaCost);
		} else {
...
int LuaScriptInterface::luaMonsterTypeBaseSpeed(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.baseSpeed);
		} else {
...
int LuaScriptInterface::luaMonsterTypeLight(lua_State* L) {
	...
	if (lua_gettop(L) == 1) {
		lua::pushNumber(L, monsterType->info.light.level);
		lua::pushNumber(L, monsterType->info.light.color);
		return 2;
	} else {
...
int LuaScriptInterface::luaMonsterTypeStaticAttackChance(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.staticAttackChance);
		} else {
...
int LuaScriptInterface::luaMonsterTypeTargetDistance(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.targetDistance);
		} else {
...
int LuaScriptInterface::luaMonsterTypeYellChance(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.yellChance);
		} else {
...
int LuaScriptInterface::luaMonsterTypeYellSpeedTicks(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.yellSpeedTicks);
		} else {
...
int LuaScriptInterface::luaMonsterTypeChangeTargetChance(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.changeTargetChance);
		} else {
...
int LuaScriptInterface::luaMonsterTypeChangeTargetSpeed(lua_State* L) {
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, monsterType->info.changeTargetSpeed);
		} else {
...
int LuaScriptInterface::luaPartyGetMemberCount(lua_State* L) {
	...
	Party* party = lua::getUserdata<Party>(L, 1);
	if (party) {
		lua::pushNumber(L, party->getMemberCount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPartyGetInviteeCount(lua_State* L) {
	...
	Party* party = lua::getUserdata<Party>(L, 1);
	if (party) {
		lua::pushNumber(L, party->getInvitationCount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaSpellGroup(lua_State* L) {
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, spell->getGroup());
			lua::pushNumber(L, spell->getSecondaryGroup());
			return 2;
...
int LuaScriptInterface::luaSpellCooldown(lua_State* L) {
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, spell->getCooldown());
		} else {
...
int LuaScriptInterface::luaSpellGroupCooldown(lua_State* L) {
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, spell->getGroupCooldown());
			lua::pushNumber(L, spell->getSecondaryCooldown());
			return 2;
		} else if (lua_gettop(L) == 2) {
...
int LuaScriptInterface::luaSpellLevel(lua_State* L) {
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, spell->getLevel());
		} else {
...
int LuaScriptInterface::luaSpellMagicLevel(lua_State* L) {
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, spell->getMagicLevel());
		} else {
...
int LuaScriptInterface::luaSpellMana(lua_State* L) {
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, spell->getMana());
		} else {
...
int LuaScriptInterface::luaSpellManaPercent(lua_State* L) {
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, spell->getManaPercent());
		} else {
...
int LuaScriptInterface::luaSpellSoul(lua_State* L) {
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, spell->getSoulCost());
		} else {
...
int LuaScriptInterface::luaSpellRange(lua_State* L) {
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, spell->getRange());
		} else {
...
int LuaScriptInterface::luaSpellRuneId(lua_State* L) {
	...
	if (rune) {
		...
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, rune->getRuneItemId());
		} else {
...
int LuaScriptInterface::luaSpellCharges(lua_State* L) {
	...
	if (spell) {
		...
		if (lua_gettop(L) == 1) {
			lua::pushNumber(L, spell->getCharges());
		} else {
